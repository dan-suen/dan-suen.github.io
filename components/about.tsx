  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        little details because it shows there's a human who cares on the other
        side. My favorite anecdote goes like this:
      </p>
      <p>
        <strong>
          ...
          older game from the 90s, you're going to wish you had a skip button.
        </strong>
      </p>
      <p>
