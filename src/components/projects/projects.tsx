            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  simulates the ability to create and delete items in an online
                  marketplace. Users are view items being listed and mark them
                  as favourites or even inquire the owner via a messaging
                  system.
                </p>
              </div>
            </div>
